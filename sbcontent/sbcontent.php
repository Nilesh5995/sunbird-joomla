...
$lang->load('plg_tjtextmedia_sbcontent', JPATH_ADMINISTRATOR);
 ...
 * @since  1.0.0
 */
class PlgTjtextmediaSbcontent extends CMSPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_tjtextmediaContentInfo($config=array('sbcontent'))
	{
		...
		$obj 			= array();
		$obj['name']	= $this->params->get('plugin_name', 'Sunbird as content');
		$obj['id']		= $this->_name;
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_sbcontentContentHTML($mod_id , $lesson_id, $lesson, $comp_params)
	{
		$result = array();
	 ...
	 * @since 1.0.0
	 */
	public function sbcontentrenderPluginHTML($config)
	{
	...
	public function additionalsbcontentFormatCheck($lessonId, $mediaObj)
	{
		return $mediaObj;
	}
	 ...
	 * @since 1.0.0
	 * */
	public function sbcontent_updatedata()
	{
