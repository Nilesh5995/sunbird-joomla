...
$lang->load('plg_tjtextmedia_contenteditor', JPATH_ADMINISTRATOR);
 ...
 * @since  1.0.0
 */
class PlgTjtextmediacontenteditor extends JPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_tjtextmediaContentInfo($config = array('contenteditor'))
	{
		...
		$obj 			= array();
		$obj['name']	= $this->params->get('plugin_name', 'Sunbird Content Editor');
		$obj['id']		= $this->_name;
	 ...
	 * @since 1.0.0
	 */
	public function getSubFormat_contenteditorContentHTML($mod_id , $lesson_id, $lesson, $comp_params)
	{
		$html = '';
		$result = array();
